...
public class TreasureBlockEntities {
	...
	static {
		...
		DREAD_PIRATE_CHEST_BLOCK_ENTITY_TYPE = Registration.BLOCK_ENTITIES.register("dread_pirate_chest_block_entity", () -> BlockEntityType.Builder.of(DreadPirateChestBlockEntity::new, TreasureBlocks.DREAD_PIRATE_CHEST.get()).build(null));
